...
const GraphComponent = () => {
  ...
  const runKruskal = () => {
    ...
    if (edges.length === 0) {
      Swal.fire({
        title: "¡Oh no!",
        text: "No hay aristas en tu grafo. Kruskal necesita aristas para encontrar el árbol de expansión mínima.",
        icon: "warning",
        confirmButtonText: "Entendido",
        confirmButtonColor: "#95bb59",
        customClass: {
    ...
    Swal.fire({
      ...
      text: `Se ha encontrado el árbol de expansión mínima con un peso total de: ${pesoTotal}`,
      icon: "success",
      confirmButtonText: "Genial",
      confirmButtonColor: "#95bb59",
      customClass: {
...
useEffect(() => {
  ...
  const actions = [
    { icon: <SchoolIcon sx={{ color: "rgb(216, 182, 255)" }} />, name: "Kruskal Maximizar", action: runKruskalMax},
    { icon: <CalculateIcon  sx={{ color: "rgb(216, 182, 255)"}} />, name: "Kruskal Minimizar", action: runKruskal },
  ];
